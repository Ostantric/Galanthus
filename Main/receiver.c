  ...
  if (rf95.waitAvailableTimeout(800))
  {
    ...
    if (rf95.recv(buf, &len))
    {
      ...
      else if ((yvalue <= 450) && (xvalue <= 450)) //forward+left
      {
        ...
        if (xvalue < yvalue)
        {
          turn1 = map(tempx, 127, 1, maxturn,  1);
          turn2 = map(tempx, 127, 1, -maxturn, -1);
          power1 = ymapnegative;
          power2 = ymap;
          power3 = ymap + turn1;
        ...
        {
          turn1 = map(tempx, 127, 1, maxturn2, 1);
        turn2 = map(tempx, 127, 1, -maxturn2, -1);
      ...
      {
        tempx = map(xvalue, 580, 1023, 1, 127);
        turn1 = map(tempx, 127, 1, 80, 1);
        turn2 = map(tempx, 127, 1, -80, -1);
        ymap = map(yvalue, 0, 450, 127, 1);
        ymapnegative = map(yvalue, 0, 450, -127, -1);
        Serial.print(" turn1: ");
        Serial.print(turn1);
        ...
        if (tempx > ymap)
        {
          turn1 = map(tempx, 1, 127, 1, maxturn);
          turn2 = map(tempx, 1, 127, -1, -maxturn);
          power1 = ymapnegative + turn2;
          power2 = ymap + turn1;
          power3 = ymap;
          power4 = ymapnegative;
        ...
        {
          turn1 = map(tempx, 1, 127, 1, maxturn2);
          turn2 = map(tempx, 1, 127, -1, -maxturn2);
          power1 = ymapnegative;
          power2 = ymap;
          power3 = ymap - turn1;
          power4 = ymapnegative - turn2;
      ...
      {
        tempx = map(xvalue, 0, 450, 125, 1);

        ymap = map(yvalue, 580, 1023, 1, 127);
        ymapnegative = map(yvalue, 580, 1023, -1, -127);
        Serial.print(" tempx: ");
        Serial.print(tempx);
        Serial.print(" ymap: ");
        Serial.print(ymap);
        ...
        if (tempx > ymap)
        {
          turn1 = map(tempx, 125, 1, maxturn, 1);
          turn2 = map(tempx, 125, 1, -maxturn, -1);
          power1 = ymap;
          power2 = ymapnegative;
          power3 = ymapnegative + turn2;
          power4 = ymap + turn1;
          Serial.print("x>y");
          Serial.print(" ");
        }
        ...
        {
          turn1 = map(tempx, 125, 1, maxturn2, 1);
          turn2 = map(tempx, 125, 1, -maxturn2, -1);
          power1 = ymap - turn1;
          power2 = ymapnegative - turn2;
          power3 = ymapnegative;
          power4 = ymap;
          Serial.print("x<y");
          Serial.print(" ");
      ...
      {
        tempx = map(xvalue, 580, 1023, 1, 125);
        ymap = map(yvalue, 580, 1023, 1, 127);
        ymapnegative = map(yvalue, 580, 1023, -1, -127);
        Serial.print(" tempx: ");
        Serial.print(tempx);
        ...
        if (tempx > ymap)
        {
          turn1 = map(tempx, 1, 125, 1, maxturn);
          turn2 = map(tempx, 1, 125, -1, -maxturn);
          power1 = ymap + turn1;
          power2 = ymapnegative + turn2;
          power3 = ymapnegative;
          power4 = ymap;
        ...
        {
          turn1 = map(tempx, 1, 125, 1, maxturn2);
          turn2 = map(tempx, 1, 125, -1, -maxturn2);
          power1 = ymap;
          power2 = ymapnegative;
          power3 = ymapnegative - turn2;
          power4 = ymap - turn1;
